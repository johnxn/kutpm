...
#define UTPM_CONNECT_ERR (UTPM_BASE + 100)  // failed to connect to utpmd.
#define UTPM_KERNEL_ERR (UTPM_BASE + 101) // kernel error.
#define UTPM_SENT_FAIL (UTPM_BASE + 102)
#define UTPM_ROCKEY_FAIL (UTPM_BASE + 103) // rockey failed to response.
